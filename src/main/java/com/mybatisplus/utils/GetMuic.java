...
public class GetMuic {
    ...
    public Muicpojo getMuicV3(String SongName) throws IOException {
...
// 使用的是https://admin.alapi.cn/account/center 这个网站的接口
        ...
        Document document1 = Jsoup.connect(musicUrl).
        ...
        Muicpojo muicpojo = new Muicpojo();
        muicpojo.setMusic(songName);
        muicpojo.setMusicUrl("https://music.163.com/#/song?id=" + id );
        muicpojo.setUrl("http://music.163.com/song/media/outer/url?id=" + id);
        muicpojo.setNickUser( artistsName);
        muicpojo.setPicture(src);

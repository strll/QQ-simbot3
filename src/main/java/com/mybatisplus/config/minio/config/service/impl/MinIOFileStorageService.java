package com.mybatisplus.config.minio.config.service.impl;


import com.mybatisplus.config.minio.config.MinIOConfig;
import com.mybatisplus.config.minio.config.MinIOConfigProperties;
